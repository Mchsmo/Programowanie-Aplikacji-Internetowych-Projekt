        ...
        <div class="col-8 col-12-medium">
            <article class="box post">
                ...
                <section>
                    ...
                    @auth
                        <form action="{{ route('comments.store', $recipe->id_recipe) }}" method="POST" onsubmit="this.querySelector('button[type=submit]').disabled=true; this.querySelector('button[type=submit]').innerText='Zapisywanie...'; return true;">
                            @csrf
